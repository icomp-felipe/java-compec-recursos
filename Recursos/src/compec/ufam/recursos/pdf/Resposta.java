...
public class Resposta {
	 ...
	 *  @param dataRetificacao - data de retificação do documento
	...
	public static void show(final String edital, final LocalDate dataPublicacao, final LocalDate dataRetificacao, final File planilha, final List<Recurso> listaRecursos) throws IOException, JRException {
		
		// Construindo o relatório
		JasperPrint prints = buildReport(edital, dataPublicacao, dataRetificacao, planilha, listaRecursos);
	 ...
	 *  @throws IOException quando o arquivo de logo do relatório (res/img/header-portrait.png) está inacessível
	 *  @throws JRException quando há alguma falha no carregamento do relatório Jasper */
	public static void exportPDF(final String edital, final LocalDate dataPublicacao, final LocalDate dataRetificacao, final File planilha, final List<Recurso> listaRecursos, final File dirSaida) throws IOException, JRException {
	 ...
	 *  @throws IOException quando o arquivo de logo do relatório (res/img/header-portrait.png) está inacessível
	 *  @throws JRException quando há alguma falha no carregamento do relatório Jasper */
	private static JasperPrint buildReport(final String edital, final LocalDate dataPublicacao, final LocalDate dataRetificacao, final File planilha, final List<Recurso> listaRecursos) throws IOException, JRException {
		...
		parameters.put("PAR_DATA_PUBLICACAO" , dataPublicacao.format(DateTimeFormatter.ofPattern("dd/MM/yyyy")));
		parameters.put("PAR_DATA_RETIFICACAO", dataRetificacao == null ? null : dataRetificacao.format(DateTimeFormatter.ofPattern("dd/MM/yyyy")));
